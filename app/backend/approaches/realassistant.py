...
if __name__ == "__main__":
    ...
    user_query = "Give me 5 top properties with 3 bedrooms and a living area less than ​​400 square meters, with a price ranging between 0.1 million and 0.5 million riyals."
